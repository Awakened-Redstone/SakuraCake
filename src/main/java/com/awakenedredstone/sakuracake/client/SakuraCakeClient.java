    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (elytraBoost.wasPressed()) {
                if (!player.isFallFlying()) break;
                if (!(equippedStack.getItem() instanceof PhoenixElytraItem)) break;
                if (cooldown.isCoolingDown(equippedStack.getItem())) break;
                ...
                if (!equippedStack.getOrCreateNbt().getBoolean("noCooldown")) cooldown.set(equippedStack.getItem(), 400);
            }
        });
    }
